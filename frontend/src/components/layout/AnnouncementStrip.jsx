...
const ANNOUNCEMENTS = [
  '🎉 Early-bird offer: 25% off the FCPS Part-1 January batch — enrol before 30 September.',
  '🩺 New BCS (Health) written batch starts 5 October. Limited seats.',
  '📞 Admission helpline: +880 1700-000000 (10 AM – 8 PM)',
];
