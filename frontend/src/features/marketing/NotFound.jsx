...
export default function NotFound() {
  return (
    <div className="container-page flex min-h-[60vh] flex-col items-center justify-center text-center">
      ...
      <h1 className="mt-4 text-2xl font-bold text-stone-900 dark:text-white">Page not found</h1>
      <p className="mt-2 max-w-md text-sm text-stone-600 dark:text-brand-200">
